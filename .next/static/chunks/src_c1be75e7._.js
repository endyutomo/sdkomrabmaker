...
"[project]/src/ai/flows/data:983105 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/ai/puter-ai-adapter.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function callPuterAI(prompt) {
    ...
    if ("object" === 'undefined' || !window.puter) {
    ...
    try {
        ...
        if (!model) {
            const provider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$ai$2d$provider$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveProvider"])();
            if (provider === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$ai$2d$provider$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AIProvider"].OPENAI) {
                model = 'gpt-5-nano'; // As requested by user
            } else if (provider === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$ai$2d$provider$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AIProvider"].CLAUDE) {
                model = 'claude-sonnet-4-5'; // As requested by user
            } else if (provider === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$ai$2d$provider$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AIProvider"].GROK) {
                model = 'x-ai/grok-4-1-fast'; // As requested by user
            } else if (provider === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$ai$2d$provider$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AIProvider"].GEMINI_3_PRO) {
        ...
        if (typeof response === 'object' && ((_message = response.message) === null || _message === void 0 ? void 0 : _message.content)) {
            return response.message.content;
        }
        return response;
    } catch (error) {
        console.error('Puter AI Error:', error);
        throw new Error("Puter AI failed: ".concat(error instanceof Error ? error.message : 'Unknown error'));
    }
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$983105__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:983105 [app-client] (ecmascript) <text/javascript>");
    ...
    const handleSuggestPrice = async (categoryId, item)=>{
        ...
        try {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$puter$2d$ai$2d$adapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldUsePuterAI"])()) {
                ...
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$983105__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["suggestItemPrice"])(input);
            }
...
//# sourceMappingURL=src_c1be75e7._.js.map