...
function DashboardPage() {
    ...
    const { data: ownedProjects, isLoading: isOwnedLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$supabase$2d$query$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSupabaseQuery"])('projects', (q)=>q.order('updated_at', {
            ascending: false
        }));
